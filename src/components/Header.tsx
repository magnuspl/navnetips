        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            <Link to="/" className="flex items-center space-x-4 group">
              <div className="p-3 bg-yellow-300 border-4 border-black transform -rotate-3 transition-transform duration-300 hover:rotate-3">
            ...
            <div className="bg-white border-4 border-black p-1">
              <div className="flex items-center">
                ...
                <input
                  ...
                  className="pl-2 pr-4 py-2 focus:outline-none w-full sm:w-64 bg-transparent placeholder-black"
                  value={searchTerm}
