...
export const norronePAA: Record<string, NameDetail> = {
  ragnar: {
    elements: [
      { form: "regin", sense: "råd, makter, gudene" },
  ...
  vigdis: {
    elements: [
      { form: "víg", sense: "kamp, drap" },
      { form: "dís", sense: "gudinne, kvinnelig vette" },
    ],
    origin:
