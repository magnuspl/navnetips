...
export const names: NameEntry[] = [
  ...
  { name: "Alma", slug: "alma", categories: ["jente"], meaning: "Nærende", origin: "Latin", styles: ["moderne"] },
  ...
  { name: "Angus", slug: "angus", categories: ["hund"], meaning: "Ett valg, én kraft", origin: "Skotsk", styles: ["unikt"] },
  ...
  { name: "Bailey", slug: "bailey", categories: ["hund"], meaning: "Forvalter", origin: "Engelsk", styles: ["klassisk"] },
  { name: "Balder", slug: "balder", categories: ["hund"], meaning: "Herre, den lyse", origin: "Norrønt", styles: ["moderne"] },
  ...
  { name: "Benji", slug: "benji", categories: ["hund"], meaning: "Sønn ved høyre hånd", origin: "Hebraisk", styles: ["klassisk"] },
  ...
  { name: "Bruce", slug: "bruce", categories: ["hund"], meaning: "Normannisk stedsnavn", origin: "Fransk", styles: ["unikt"] },
  ...
  { name: "Chloe", slug: "chloe", categories: ["hund"], meaning: "Grønt skudd", origin: "Gresk", styles: ["klassisk"] },
  ...
  { name: "Embla", slug: "embla", categories: ["jente"], meaning: "Alm, slyngtre", origin: "Norrønt", styles: ["norrønt", "unikt"] },
  ...
  { name: "Frida", slug: "frida", categories: ["jente"], meaning: "Vakker og elsket", origin: "Norrønt", styles: ["norrønt", "unikt"] },
  ...
  { name: "George", slug: "george", categories: ["hund"], meaning: "Jordbruker", origin: "Gresk", styles: ["klassisk"] },
  ...
  { name: "Gus", slug: "gus", categories: ["hund"], meaning: "Kortform av August", origin: "Germansk", styles: ["klassisk"] },
  ...
  { name: "Hank", slug: "hank", categories: ["hund"], meaning: "Kortform av Henry", origin: "Hebraisk", styles: ["klassisk"] },
  ...
  { name: "Jackson", slug: "jackson", categories: ["hund"], meaning: "Jacks sønn", origin: "Engelsk", styles: ["klassisk"] },
  ...
  { name: "Kira", slug: "kira", categories: ["hund"], meaning: "Herskerinne", origin: "Russisk", styles: ["unikt"] },
  ...
  { name: "Loki", slug: "loki", categories: ["katt"], meaning: "Den som knytter", origin: "Norrønt", styles: ["unikt"] },
  { name: "Lola", slug: "lola", categories: ["hund"], meaning: "Kortform av Dolores", origin: "Spansk", styles: ["klassisk"] },
  ...
  { name: "Max", slug: "max", categories: ["hund"], meaning: "Den største", origin: "Latin", styles: ["klassisk"] },
  ...
  { name: "Molly", slug: "molly", categories: ["hund"], meaning: "Kjæleform av Maria", origin: "Hebraisk", styles: ["klassisk"] },
  ...
  { name: "Nala", slug: "nala", categories: ["katt"], meaning: "Gave", origin: "Afrikansk", styles: ["unikt"] },
  ...
  { name: "Odin", slug: "odin", categories: ["katt"], meaning: "Den henrykte", origin: "Norrønt", styles: ["norrønt", "unikt"] },
  ...
  { name: "Ozzy", slug: "ozzy", categories: ["hund"], meaning: "Gudemakt", origin: "Engelsk", styles: ["unikt"] },
  { name: "Patrick", slug: "patrick", categories: ["gutt"], meaning: "Av fornem ætt", origin: "Latin", styles: ["moderne"] },
  { name: "Penny", slug: "penny", categories: ["hund"], meaning: "Den som vever", origin: "Engelsk", styles: ["klassisk"] },
  ...
  { name: "Riley", slug: "riley", categories: ["hund"], meaning: "Rugeng", origin: "Irsk", styles: ["klassisk"] },
  { name: "Roar", slug: "roar", categories: ["gutt"], meaning: "Berømt spyd", origin: "Norrønt", styles: ["norrønt", "klassisk"] },
  { name: "Rocco", slug: "rocco", categories: ["hund"], meaning: "Ro", origin: "Germansk", styles: ["klassisk"] },
  ...
  { name: "Saga", slug: "saga", categories: ["jente"], meaning: "Fortelling", origin: "Norrønt", styles: ["moderne"] },
  { name: "Salem", slug: "salem", categories: ["katt"], meaning: "Fred", origin: "Hebraisk", styles: ["klassisk"] },
  { name: "Sam", slug: "sam", categories: ["hund"], meaning: "Gud har hørt", origin: "Hebraisk", styles: ["klassisk"] },
  { name: "Sammy", slug: "sammy", categories: ["hund"], meaning: "Gud har hørt", origin: "Hebraisk", styles: ["klassisk"] },
  { name: "Samson", slug: "samson", categories: ["hund"], meaning: "Solens mann", origin: "Hebraisk", styles: ["unikt"] },
  ...
  { name: "Sasha", slug: "sasha", categories: ["hund"], meaning: "Den som verner menn", origin: "Russisk", styles: ["unikt"] },
  ...
  { name: "Teddy", slug: "teddy", categories: ["hund"], meaning: "Guds gave", origin: "Germansk", styles: ["klassisk"] },
  ...
  { name: "Tiril", slug: "tiril", categories: ["jente"], meaning: "Liten fugl", origin: "Norrønt", styles: ["moderne"] },
  ...
  { name: "Vilde", slug: "vilde", categories: ["jente"], meaning: "Hersker", origin: "Germansk", styles: ["norrønt", "moderne", "unikt"] },
  ...
  { name: "Winston", slug: "winston", categories: ["hund"], meaning: "Gledens stein", origin: "Engelsk", styles: ["unikt"] },
  ...
  { name: "Zelda", slug: "zelda", categories: ["hund"], meaning: "Grå kamp", origin: "Germansk", styles: ["unikt"] },
